...
<?php
    ...
    $dosen1 = new Dosen('ANDI IWAN NURHIDAYAT', 35, 2015041003); 
    $dosen2 = new Dosen('HAFIZHUDDIN ZUL FAHMI', 35,2015042006 );
    $dosen3 = new Dosen('I GDE AGUNG SRI SIDHIMANTRA', 30, 2019031016);
